...
Personal zsh configuration repository containing plugins and themes designed for use with Oh My Zsh or similar zsh frameworks. The plugins provide environment setup, aliases, and utility functions primarily for macOS development.
